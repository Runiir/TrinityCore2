...
DRUDGE_FILES = {
    ...
    "BotWorldPopulationMgrValidationRouteDrudgeCombat.cpp",
    "BotWorldPopulationMgrValidationRouteDrudgeGroupSafety.cpp",
    ...
    "BotRaidDrudgeMinimumDistanceExit.h",
    "BotWorldPopulationMgrValidationRouteDrudgeMinimumDistance.cpp",
    "BotWorldPopulationMgrValidationRouteDrudgeFutureBossBoundary.cpp",
