...
def test_walkable_descent_uses_bounded_native_movement_while_declared_jump_stays_fail_closed():
    ...
    assert "bot->IsWithinLOS(candidateX, candidateY, candidateZ)" not in move_bot_to_point
    ...
    assert 'descentRejectReason = "route_descent_landing_no_los";' not in move_bot_to_point
