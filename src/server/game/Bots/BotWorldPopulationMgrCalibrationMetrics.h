...
// declaration order.
    struct CalibrationMetrics
    {
        ...
        struct AfflictionDamageStageObservation
        {
            ...
            uint32 DirectSpellmodObservationCount = 0;
            int32 DirectSpellmodFlatMin = 0;
            int32 DirectSpellmodFlatMax = 0;
            uint64 DirectSpellmodMultiplierPpmSum = 0;
            uint32 DirectSpellmodMultiplierPpmMin = 0;
            uint32 DirectSpellmodMultiplierPpmMax = 0;
            uint32 PeriodicSpellmodObservationCount = 0;
            int32 PeriodicSpellmodFlatMin = 0;
            int32 PeriodicSpellmodFlatMax = 0;
        ...
        std::array<OwnerAuraObservation, 5> OwnerAuraObservations;
