#ifndef TRINITY_BOT_HIGH_PRIESTESS_AZIL_SWARM_THREAT_SAFETY_H
#define TRINITY_BOT_HIGH_PRIESTESS_AZIL_SWARM_THREAT_SAFETY_H
...
struct SwarmThreatSafetyRequest
{
    ...
    HunterThreatTransferResult const* HunterThreatTransfer = nullptr;
    Unit* Add = nullptr;
