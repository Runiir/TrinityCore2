...
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 15, 3045, 'offensive_cooldown', 'rapid_fire,burn', 0.95, 0, 0, 0, 0, 1, 1.00, 0, 'self', 'ranged', 'ranged'),
