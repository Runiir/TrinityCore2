...
(8, 'fire', 'dps', 'mana', 'ranged', 'ranged', 'none', 0, 35, 1, 'stonecore_5n_cata_guide_seed', 'initial focused coverage for stonecore_5n; insert more rows for other specs'),
(3, 'marksmanship', 'dps', 'focus', 'ranged', 'ranged', 'ranged', 5, 35, 1, 'stonecore_5n_cata_guide_seed', 'initial focused coverage for stonecore_5n; insert more rows for other specs'),
...
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=8 AND `spec_tag`='fire' AND `role`='dps'), 20, 44457, 'dot', 'living_bomb,maintain_debuff', 0.98, 0, 1, 1, 0, 44457, 0, 'enemy', 'ranged', 'none', 0, 35, 0, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=8 AND `spec_tag`='fire' AND `role`='dps'), 30, 92315, 'spender', 'pyroblast,hot_streak_only,instant_proc', 1.00, 0, 1, 1, 48108, 0, 0, 'enemy', 'ranged', 'none', 0, 35, 1, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=8 AND `spec_tag`='fire' AND `role`='dps'), 40, 2120, 'aoe', 'flamestrike,aoe', 0.90, 0, 3, 4, 0, 0, 0, 'enemy', 'ranged', 'none', 0, 35, 0, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=8 AND `spec_tag`='fire' AND `role`='dps'), 50, 133, 'builder', 'fireball,filler', 0.78, 0, 4, 1, 0, 0, 0, 'enemy', 'ranged', 'none', 0, 35, 0, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=8 AND `spec_tag`='fire' AND `role`='dps'), 60, 2136, 'spender', 'fire_blast,instant', 0.70, 0, 5, 1, 0, 0, 0, 'enemy', 'ranged', 'none', 0, 35, 1, 0);
...
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 1, 13165, 'buff', 'aspect_of_the_hawk,self,prepull_required', 0.20, 0, 1, 1, 0, 'self', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 2, 883, 'buff', 'call_pet,self,prepull_required', 0.20, 0, 1, 1, 0, 'self', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 3, 982, 'buff', 'revive_pet,self,prepull_required', 0.20, 0, 1, 1, 0, 'self', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 4, 34477, 'buff', 'misdirection,tank,prepull_threat', 0.25, 0, 1, 1, 0, 'tank', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 5, 1130, 'debuff', 'hunters_mark,target,prepull', 0.35, 0, 1, 1, 1130, 'enemy', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 10, 1978, 'dot', 'serpent_sting,dot', 0.88, 1, 1, 1, 1978, 'enemy', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 20, 53209, 'spender', 'chimera_shot,focus,sting_refresh', 1.00, 1, 1, 1, 0, 'enemy', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 30, 53351, 'execute', 'kill_shot,execute', 1.00, 1, 1, 0.20, 0, 'enemy', 'ranged', 'ranged', 5, 35, 1),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 40, 19434, 'spender', 'aimed_shot,focus', 0.92, 2, 1, 1, 0, 'enemy', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 50, 2643, 'aoe', 'multi_shot,aoe', 0.90, 2, 3, 1, 0, 'enemy', 'ranged', 'ranged', 5, 35, 1),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 60, 3044, 'spender', 'arcane_shot,focus_dump', 0.80, 4, 1, 1, 0, 'enemy', 'ranged', 'ranged', 5, 35, 1),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 70, 56641, 'resource_generator', 'steady_shot,focus_builder', 0.74, 5, 1, 1, 0, 'enemy', 'ranged', 'ranged', 5, 35, 0),
((SELECT `id` FROM `bot_rotation_profile` WHERE `class_id`=3 AND `spec_tag`='marksmanship' AND `role`='dps'), 80, 75, 'auto_attack', 'auto_shot,ranged', 0.45, 7, 1, 1, 0, 'enemy', 'ranged', 'ranged', 5, 35, 1);
