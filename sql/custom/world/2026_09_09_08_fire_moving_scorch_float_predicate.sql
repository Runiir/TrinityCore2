-- Replay the Fire moving-Scorch clone with a storage-safe comparison. MySQL
-- FLOAT stores the configured 40% cap as 0.4000000059604645.
...
WHERE `profile`.`class_id` = 8
  ...
  AND ABS(`action`.`max_mana_pct` - 0.40) < 0.000001
