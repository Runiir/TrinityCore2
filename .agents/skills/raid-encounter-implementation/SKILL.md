...
Keep each encounter mechanic as a bounded policy owner. Central boss-mechanic
decisions are high-CCN; a split is useful only when it removes overlapping
ownership or branches from
