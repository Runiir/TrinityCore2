...
The blocker is unchanged and current as of pass 000477. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Redacted log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/bot_ml_export_configured_db.redacted.log`.
...
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `ae6f4375c4a9f2f0f4c5bc2c69a5fa646f2446bd` before this doc update.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/dvc_config_redacted_diff.log`.
...
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/dvc_status_selected_after_pull.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000477/dvc_status_combined_broad.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, `bot_ml_build_decisions` repro, `bot_ml_validate` repro, and `worldserver` build were not rerun in pass 000477 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
...
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000477 due the DB blocker stop condition.
...
## 2026-06-28 Orchestrator Pass 000205

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000205. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Redacted log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/bot_ml_export_configured_db.redacted.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean apart from the existing `master...origin/master [ahead 90]` branch relation. Main `pixi run dvc status`: clean.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `e7e70ca0df10290dca97fa10ae1dfb0db0e1e79b` before this doc update.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/dvc_config_redacted_diff.log`.
- Repository-level `generated/orchestrator_worktrees` contains orchestrator worktrees and none were removed by this pass.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/dvc_status_selected_final.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000205/dvc_status_combined_final.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, `bot_ml_build_decisions` repro, `bot_ml_validate` repro, and `worldserver` build were not rerun in pass 000205 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000205 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000204

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000204. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000204/bot_ml_export_configured_db.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean apart from the existing `master...origin/master [ahead 90]` branch relation. Main `pixi run dvc status`: clean.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `ecca6be764989ea9af2884d55e733a519c953a00` before this doc update.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` remains uncommitted.
- No stale nested `generated/orchestrator_worktrees` directories were found inside the combined worktree. Repository-level `generated/orchestrator_worktrees` contains orchestrator worktrees and none were removed by this pass.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000204/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000204/dvc_status_selected_after_pull.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000204 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000204 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000203

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000203. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/bot_ml_export_configured_db.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean apart from the existing `master...origin/master [ahead 90]` branch relation. Main `pixi run dvc status`: clean.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `0bf21b9475d8fc302b214d5ef4a2d02a4b1087ab` before this doc update.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/dvc_config_redacted_diff.log`.
- No stale nested `generated/orchestrator_worktrees` directories were found inside the combined worktree. Repository-level `generated/orchestrator_worktrees` contains only orchestrator worktrees and none were removed by this pass.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/dvc_status_selected_initial.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000203/dvc_status_combined_initial.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000203 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000203 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000202

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000202. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/bot_ml_export_configured_db.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean. Main `pixi run dvc status`: clean. Logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/git_status_main_start.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/dvc_status_main_start.log`.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `1ec2b7b8a5d8becc37af51bccc98088007005357` before this doc update.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/dvc_config_combined_redacted.log`.
- No stale nested `generated/orchestrator_worktrees` directories were found inside the combined worktree. Repository-level `generated/orchestrator_worktrees` contains only orchestrator worktrees and none were removed by this pass.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/dvc_status_selected_final.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000202/dvc_status_combined_broad_start.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000202 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000202 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000201

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000201. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/bot_ml_export_configured_db.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean. Main `pixi run dvc status`: clean. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_status_main_initial.log`.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `1155b59fdc47eb2edf6ad9fd5a6d246e17c50d84` before this doc update.
- Combined DVC config has the same redacted remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_config_redacted_diff.log`.
- Repository-level `generated/orchestrator_worktrees` contains only orchestrator worktrees; none were removed by this pass.
- Selected-output `pixi run dvc pull` for `bot_ml_build_decisions`, `bot_ml_validate`, and `bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_pull_selected_targets.log`.
- Selected-output `pixi run dvc status`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_status_selected_targets.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000201/dvc_status_combined_initial.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000201 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000201 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000200

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000200. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/bot_ml_export_configured_db.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean. Main `pixi run dvc status`: clean. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_status_main.log`.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `feb105eb10678e0d823c232478a18279bde40559` before this doc update.
- Combined DVC config has the same redacted remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_config_redacted_diff.log`.
- Repository-level `generated/orchestrator_worktrees` contains only orchestrator worktrees (`ml-discovery-cont`, `ml-discovery-continue`, `ml-discovery-final`); none were removed by this pass.
- Selected-output `pixi run dvc pull` for `bot_ml_build_decisions`, `bot_ml_validate`, and `bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_pull_selected_targets.log`.
- Selected-output `pixi run dvc status`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_status_selected_targets.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000200/dvc_status_combined_broad.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000200 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000200 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000199

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000199. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempt:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/bot_ml_export_configured_db.log`.

DVC and validation evidence:

- Main worktree `git status --short`: clean. Main `pixi run dvc status`: clean. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_status_main_initial.log`.
- Combined worktree was clean on `codex/ml/bt-masked-ga-combined` at commit `7cd4a258fbc38ed83e7516dabca4aff94230a319` before this doc update.
- Combined DVC config has the same redacted remote settings as main; `.dvc/config.local` remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_config_redacted_diff.log`.
- Repository-level `generated/orchestrator_worktrees` contains only orchestrator worktrees (`ml-discovery-cont`, `ml-discovery-continue`, `ml-discovery-final`); none were removed by this pass.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_status_selected_stages.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000199/dvc_status_combined_initial.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000199 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000199 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000198

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000198. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempts:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/bot_ml_export_172_20_0_2_lane_r1.log`.
- `pixi run bot-ml-export --database-url mysql://trinity:trinity@127.0.0.1:3306/characters --output-dir dataset/bot_ml/raw`: failed, connection refused. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/bot_ml_export_127_0_0_1_characters.log`.

DB availability evidence:

- Docker only showed an unrelated Postgres container and `ss -ltnp` showed no local MySQL listener on port 3306. Logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/docker_ps.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/db_listener_check.log`.
- The documented Stonecore lane characters DB endpoint remains `172.20.0.2:3306`; the Makefile/worldserver default remains localhost `characters`. Search log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/db_url_search.log`.

DVC and validation evidence:

- Main worktree `git status --short --branch`: clean. Main `pixi run dvc status`: clean. Logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/git_status_main_initial.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_status_main_initial.log`.
- Combined worktree is clean on `codex/ml/bt-masked-ga-combined` before this doc update. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/git_status_combined_initial.log`.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` is byte-equivalent to main and remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_config_local_cmp.log`.
- No stale nested `generated/orchestrator_worktrees` directories were found inside the combined worktree. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/stale_orchestrator_worktrees.log`.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_status_selected_stages.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000198/dvc_status_combined_full.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000198 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000198 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
...
## 2026-06-28 Orchestrator Pass 000197

Branch `codex/ml/bt-masked-ga-combined` remains the selected Stonecore ML path: behavior-tree learned scoring plus masked ranker, with GA retained only as an offline helper. No new strategy lane or worker/reviewer session was launched, and no C++ runtime control was added; the lane remains offline/shadow-only.

Current status: not merge-ready.

The blocker is unchanged and current as of pass 000197. `dataset/bot_ml/decision_dataset_manifest.json` still contains the fixture-scale dataset: 4 candidate rows, 2 decision rows, and 2 observed-label rows. Acceptance requires real telemetry scale, so this pass does not claim merge readiness.

DB export attempts:

- `pixi run bot-ml-export --database-url mysql://trinity:trinity@172.20.0.2:3306/characters_lane_stonecore_full_clear_r1 --output-dir dataset/bot_ml/raw`: failed, no route to host. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/bot_ml_export_172_20_0_2_lane_r1.log`.
- `pixi run bot-ml-export --database-url mysql://trinity:trinity@127.0.0.1:3306/characters --output-dir dataset/bot_ml/raw`: failed, connection refused. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/bot_ml_export_127_0_0_1_characters.log`.

DB availability evidence:

- Docker only showed an unrelated Postgres container and `ss -ltnp` showed no local MySQL listener on port 3306. Logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/docker_ps.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/db_listener_check.log`.
- The documented Stonecore lane characters DB endpoint remains `172.20.0.2:3306`; the Makefile/worldserver default remains localhost `characters`. Search log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/db_url_search.log`.

DVC and validation evidence:

- Main worktree `git status --short --branch`: clean. Main `pixi run dvc status`: clean. Logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/git_status_main_initial.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_status_main_initial.log`.
- Combined worktree is clean on `codex/ml/bt-masked-ga-combined` before this doc update. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/git_status_combined_initial.log`.
- Combined DVC config has the same remote settings as main; `.dvc/config.local` is byte-equivalent to main and remains uncommitted. Redacted logs: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_config_main_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_config_combined_redacted.log`, `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_config_local_cmp.log`.
- No stale nested `generated/orchestrator_worktrees` directories were found inside the combined worktree. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/stale_orchestrator_worktrees.log`.
- `pixi run dvc pull bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, everything is up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_pull_selected_stages.log`.
- `pixi run dvc status bot_ml_build_decisions bot_ml_validate bt_masked_ga_combined`: passed, data and pipelines are up to date. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_status_selected_stages.log`.
- Broad combined `pixi run dvc status`: still reports historical deleted-output state outside the selected combined lane. Log: `/home/runiir/Games/trinity-cata/.codex/plans/orchestrator/instances/ml-discovery-final/runs/000197/dvc_status_combined_full.log`.
- Focused/full ML tests, `bt_masked_ga_combined` repro, and `worldserver` build were not rerun in pass 000197 because DB export remained unavailable and the prompt says to stop and write a blocker report when DB access is not available.
- No selected DVC artifacts changed, so `pixi run dvc push` was not run.
...
- DVC stage reproduces cleanly: selected DVC graph is up to date, but real dataset repro is blocked by DB access.
- Focused and full ML tests pass: latest passing evidence remains pass 000004; not rerun in pass 000197 due the DB blocker stop condition.
- Dataset has real telemetry scale: no, blocked by unreachable characters DB.
- Server-valid candidate masks are preserved: yes in current fixture metrics.
- Stonecore baseline comparison shows no regression: yes in current fixture metrics.
- `control_eligible=false` and runtime mode remains offline/shadow only: yes.
