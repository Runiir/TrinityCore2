...
| DPS-064 | open | Fire Mages | Fire A 0.99 / 0.90 / 0.92 across b2, b3, b4 (sd 6.4k): the fixed baiter duty makes it a coin flip; next: alternate the baiter per wave |  |
| DPS-065 | open | Several DPS actors and references | Effective cast time + moving Moonfire kept on b2-fd4ba456; Balance 0.943 |  |
| DPS-066 | open | Elemental Shaman | Elemental 41950 (1.00, improved) on b4-2c0ed2d8; actor_30010 accepted; close after the next batch confirms |  |
...
| HEAL-003 | open | Healers | Bundle 04 kept: no strand in 6 kills; close after the next batch confirms |  |
...
| TANK-002 | open | Blood Death Knight tank | 0.948 on b4-2c0ed2d8 (kept); remaining: Heart Strike blocked for ~11 s while seized (forbidden_self_aura 136x/kill), Bone Shield recast timing, Rune Weapon copies 67% |  |
| TANK-003 | open | Blood Death Knight tank | Bundle 04 kept (0 deaths); Bone Shield reservation for the seize still open |  |
