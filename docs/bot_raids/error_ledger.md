...
| --- | --- | --- | --- |
| DPS-045 | Closer WCL class reference selected; normalized roster baseline pending | Y8ajQ7dbmKMG1RZy fight22:10N,111.3s,9 participants2/2/5,246232.7DPS,avg395.33; includes all four caster DPS specs and Blood. No MM. Native Aff is14.11% belowff; Blood/healers have no permanent item enchants. | Compare all represented roles by actual admission gear/stats, phase, cast cadence, pet output, buffs/potions and target accounting before choosing the next repair. Do not equate generic validation-profile flags or item-level averages with final profession-equipment overrides. See magmaw_dps_baseline_20260913.md. |
