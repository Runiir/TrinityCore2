...
| DPS-053 | Native Doomguard melee-only AI proven on63d | Legacy11859 has no AI/script binding and old spells; AggressorAI matches21 melee hits and zero Doom Bolts. | Bind native85692 caster behavior with owner target authority, native range/lifetime and owner-SP response. Preserve primary Felhunter and coefficients. Validate actual casts/landed outcomes. |
