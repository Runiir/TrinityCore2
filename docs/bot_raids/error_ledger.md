...
| --- | --- | --- | --- |
| DPS-049 | Action/provisioning admission accepted on63d; full guardian behavior failed | Native18540 creates11859 for45s alongside primary417. Only21 melee/8,287 damage, no85692. | Preserve admission. Route native AI/spell binding to DPS-053; token damage is not end-to-end guardian acceptance. |
| DPS-053 | Native Doomguard melee-only AI proven on63d | Legacy11859 has no AI/script binding and old spells; AggressorAI matches21 melee hits and zero Doom Bolts. | Bind native85692 casting to targets bearing the summoner's Bane of Doom or Agony, with native range/lifetime and owner-SP response. The initial arbitrary owner-attack design was wrong and never deployed. Preserve primary Felhunter and coefficients. Validate actual casts/landed outcomes. |
...
| DPS-050 | Blood AP loss after MM swap; buff-coverage diagnosis active | Same native gear/talents, but05f Blood AP is5/6 ofee from spawn; removed MM had Trueshot Aura. Heart Strike also rejects under area semantics at one observed hostile. | Verify replacement raid buff coverage and native blessing/provisioning path; keep Vengeance, equipment, HeartStrike and unmatched WCL gaps separate. |
...
| DPS-052 | Fire Combustion opportunity diagnosis active | Runtime requires Ignite tick>=10000 plus LivingBomb and Pyro; pinned APL uses estimated total Combustion output and timing windows. Existing totals do not prove a missed legal opportunity. | Determine exact missing timed aura/proc observations or prove a rejected useful window before changing the gate. Both Fire actors remain open. |
...
| MOV-001 | Bounded repair accepted onff226 | On `89cef294b6`, Elemental30010 decision1214 at +37.725s selects a parasite escape endpoint at16yd while already31.311yd away. Receipt327/spline3197 confirms native inward progress; the task releases at clearance>=16 despite continued pursuit. Infection follows at+42.834s. | Keep pursuit armed, suppress inward escape destinations, and retire movement legs separately from the threat episode. Production replay fails on89cef and22 focused tests pass. ff226 clears132.828s/212,252.861DPS/11,764.605HPS with no incoming78941 events; Independent review confirms outward20yd selection from15.970yd, six native progress samples and arrival, then same-episode rearm. A later native path-control rejection remains unresolved; do not claim all escape paths pass. Frozen incident and all-bot review are in the one-tank Balance DVC archive. |
