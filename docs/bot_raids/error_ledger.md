...
| DPS-055 | Blood/healer permanent enchants absent; all four source overlays now reviewed | Source presets omitted role profession_equipment. WCL same-spec slot sources now cover Blood/Holy/Disc plus Restoration TGHNp7WhFJ3n8z4a fight3/source1; local healer p4 presets are Wrath. | Apply native-legal enchant-only overlays with exact source authority, preserving current items/gems/reforges. Disc rings require Enchanting; Resto offhand omitted for 2H staff. Complete profession choice and role-optimal gearing remain separate. |
| DPS-048 | Survival sustained AoE remains unproved; Horn renewal is healthy | Source9d29 still has zero Multi-Shot/Spread damage, but its two retained high-density samples are GCD-blocked and do not prove a legal lost cast. Horn renewed at34.991yd and remained present. Nine Cobra casts ended INTERRUPTED against valid targets, six while stationary; cancellation owner is absent. | Do not add an AoE row from sampled density alone. Obtain per-hostile owner-Sting state and a GCD-ready legal opportunity; route Cobra interrupt ownership through OBS-008 rather than changing shot policy. |
...
| DPS-063 | Native moving-cast facing overwrite proven; implementation underway, not accepted | Four Scorches, two per Fire actor, prepared against live attackable Magmaw and ended UNIT_NOT_INFRONT. For the earliest cast, a replacement spline's travel tangent diverged from the target bearing before terminal failure. These four casts are bounded evidence, not the whole Fire or raid gap. | Implement only `/tmp/magmaw-cast-facing-repair-packet-20260919.json`: preserve permitted movement and native arc checks while the active cast owns facing. Require compiled replay, independent review, clean build and matched live terminal evidence. No repeated SetFacing, spline stop, LOS/Z/radius relaxation or damage tuning. |
| TANK-001 | Blood boss-window death and healer response remain unresolved; post-run survival accounting repaired | Blood30002 died at+103.997s after seven late Mangles and no Death Strike in the final14.711s, losing24.745s of boss offense. Tree, Divine Favor and Pain Suppression were spent before pull; near death hard heals were movement-gated. A separate diagnostic repair passed59 tests and replay, preserving dead-at-native-death separately from post-encounter recovery; the original summary is immutable and gameplay remains9d29. Health, absorbs, mitigation, DS basis and cancellation ownership are incomplete. | Retain the death as a failed survival outcome despite post-clear recovery. Capture event-local health/runes/defensives/absorbs and candidate arbitration; reserve boss cooldowns and validate movement-safe triage before attributing preventability. |
| PET-001 | Totem-owned elemental classification can be skipped before an existing-victim update | First friendly effect is Fire Shield area damage to a same-raid wolf; wolf explicit retaliation follows, then elemental melee. Through death: elemental→wolf159,090 and wolf→elemental12,260. Runtime control flags were not logged; source exposes the skipped initialization. | Initialize player control before victim/area search and preserve native target-validity rules, including lawful hostility. Do not introduce an unconditional raid-membership ban. Require legal-enemy positive fixture and zero friendly-pet damage in the next live run. |
