...
| --- | --- | --- | --- |
| OBS-012 | Periodic critical/target-state export missing; independently approved in01f75a5c8b; native build/live pending | Ordinary damage events omit available periodic critical/chance and pre-damage health; timeline drops raw_amount. Same-cohort share callback can consume pending outcome before tuple match. | Extend existing event/full+delta/timeline, exact tuple consumption, schema5 backward-compatible consumers. No inferred direct crit, buffs, absorb, or cast correlation. |
| DPS-056 | Optional support Doom placement displaces boss Bane | db67 optional parasite603 replaces body Bane and shortens useful Doomguard targeting. Global old-aura lock was rejected because mandatory head/threat/bait assignments must win. | Exclude exact603 only on optional support targets in both preview and execution; preserve independent native-failure exclusion and980. Use controlling target-purpose addendum. |
...
| DPS-054 | Elemental routinely maintains unnecessary Tremor | Source63d casts8143 at+0.894/+61.534/+122.824 with no fear demand; totem setup returns before offensive profile. | Make earth slot optional without fear and retain legitimate reactive Tremor. Fewer Lava Surge resets/movement explain part of observed decline, not this entire loss. |
...
| DPS-048 | Survival sustained AoE branch omitted; legal lost cast unproven | Pinned simulator selects an unconditional MultiShot/Cobra AoE list at4+ targets; runtime has only the hidden-ST Sting-missing row. Latest4+ sampled opportunities fail real GCD/range gates. | Add a separate density-gated sustained AoE branch after the active repair; preserve native legality, two-target spread and Cobra fallback. Do not claim sampled legal casts were lost. |
...
| DPS-051 | Admission repaired and independently approved in7680fd9b7c; native live pending | Both shadow area classifiers now use shared root33831 exception. Existing guardian authority fromf041/db67 is preserved. | Build once with OBS-012; prove3 owned1964 summons and legal native damage, preserve reservation and true AoE gates.19 focused tests pass; unrelated Hunter fixture drift fixed ineafe0cca2e;2tests pass. |
...
| MOV-001 | Pursuit/rearm accepted onff226; new native admission implemented, live branch pending on9a | db67 receipts377/378 proved ignored qualified native escape; real planner/executor fixture now submits unchanged endpoints. 9a clears with zero Infection but never exercises the new branch. | Preserve existing guards and native coordinates. Check new traversal/spline/progress/task stop during subsequent class canaries; do not claim end-to-end acceptance or repeat unchanged merely to seek the branch. |
