...
| PET-001 | Same-raid owned pets attack each other | Elemental's Fire Elemental dealt165,675 friendly damage to the Survival wolf; the wolf also dealt34,295 attributed damage to the elemental. Gross observed ceiling is1,286.876 DPS, while recoverable boss damage is unknown. | Reject same-raid-owned units before pet/guardian attack acquisition while preserving both boss targets. Validate reciprocal-zero fixture and native boss targeting; do not tune guardian coefficients. |
