...
| ENC-006 | Native low pre-armor envelope recovered; exact tuning unresolved | The a4b9 raw stream retains24 Magmaw melee callbacks, raw4,466-8,012, health20,127,17zero-health. Native raw is after done/taken modifiers but before armor/outcome, unlike WCL U. Legacy zero-health cause and real absorption are unavailable. New36f8 swing stages survived a gap-free capture (224 swings), but the run died on Drudges before any Magmaw swing. DamageModifier1 is inherited, not a proven recent regression. | Use summary.incoming_damage before requesting another capture. Use isolated boss capture for ordinary-swing roll/modifier/outcome/mitigation context; do not repeat the unchanged trash gate. No guessed multiplier. See the current Magmaw baseline. |
...
| REC-001 | Full-wipe evidence deadlock; configuration repair in validation | 36f8's ten bots natively released, ran back, re-entered and resurrected. Admission froze recovery entrance 0/0/0; execution used the BWD fallback, while the tracker required a nonzero admitted trigger. Runback/re-entry/resurrection sequences stayed zero and the alive cohort stalled under recovery_evidence_pending. | Declare the verified entrance (6581, source map 0, target 669) on every BWD scenario and preserve it through generation/admission. Keep native progress evidence and watchdog limits. A recovered trash wipe is acceptable. Fixture/review/live acceptance remain separate. Original evidence: magmaw_melee_resolution_20260912 DVC archive; compact correction: recovery-stall.json. |
