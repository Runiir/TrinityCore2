...
| --- | --- | --- | --- |
| ENC-006 | Boss melee pressure uncalibrated; material native audit lead | Retained 10N native melee totals 20,127 across 24 events. Historical 10N WCL has 14 landed U estimates of 111,531-178,540. Current four Magmaw templates have DamageModifier1 from inherited migration68a3622133, shared by all three compared sources; current updater receipt confirms application. Fields, defenses and setups differ; exact correction and historical regression attribution are unproven. | Audit effective native swing damage, defenses and absorbs before qualifying Vengeance, tank DPS or healing pressure. See the [current baseline](strategies/t11/blackwing_descent/magmaw.md). Do not copy the historical SQL multiplier120. |
