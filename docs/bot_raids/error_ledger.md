...
| DPS-033 | Fire moving Scorch independently approved; live pending | Fire bait has 42.500 seconds of moving Fireball rejection with Scorch mana-gated; 38.700 seconds have zero valid profile actions. | Add scoped moving Scorch with native movement capability and resource checks; preserve stationary low-mana row and higher valid priorities. |
| DPS-032 | Boss-health potion gate independently approved; live pending | On a152 the newly enabled79476 casts successfully when parasite201 is at19.11% and Magmaw is roughly66%. | Stable engaged-boss health now feeds candidate and both downstream gates. First review caught omitted consumers; corrected, with 11 focused tests passing. Native item lockout and ordinary add execute remain unchanged. |
| OBS-007 | General raid effective-stat observation independently approved; live pending | Ordinary raid snapshots expose melee AP/Vengeance, while fuller owner/pet stat collection is calibration-only. Class reviews repeatedly lack live caster/secondary-stat joins. | Native collector reused for timestamped owner/permanent-pet raid snapshots, with school-specific SP/crit and legacy fields preserved. Eight focused tests and independent review pass. Capture in the gameplay batch; no standalone rerun. |
