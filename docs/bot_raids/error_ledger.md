...
| --- | --- | --- | --- |
| DPS-056 | Affliction single-target Doom placement on ephemeral adds | db67 has16 Doom603 submissions,12 on parasites; first at+36.202 replaces useful body Bane before Doomguard expires. | Gate exclusive owned-target Doom maintenance without changing Agony multidot or guardian rules; preserve legitimate retarget when old target is no longer legal. |
| DPS-057 | Native Combustion consumer excludes Ignite/Living Bomb |11129 effect0 mask intersects Pyro92315 but excludes owned12654/44457. Pinned tooltip/simulator require all three periodic components. | Repair native mask/consumer through actual calculation; preserve existing mask and owner rules, verify all component contributions without guessed coefficients. |
...
| DPS-051 | Balance summon admission and guardian authority gaps | Force of Nature33831 is rejected by duplicated hostile-area classifiers; native Treants can independently reacquire parasites outside the owner's exact support contract. | Repair both summon admission and guardian target authority before live acceptance; preserve actual area-spell restrictions. No exemption-only canary. |
| DPS-052 | Observation accepted; native40yd/profile35yd range mismatch proven | Fire30006 at+81.395s has owned Ignite/LB/Pyro and LOS, but11129 is rejected at37.7469yd by35yd row. Observation remains explicitly approximate; casting snapshots do not prove cooldown readiness. | Repair configured range from native authority; preserve native final gates. Native missing components route DPS-057. Retain poll age/cast correlation before claiming other windows. |
...
| MOV-001 | Pursuit/rearm accepted onff226; native admission repair active ondb67 | Elemental receipts377/378 have complete projected native path, valid floor, outward clearance and ProofQualified=true, but planner ignores that proof and rejects requested-Z mismatch. No movement is submitted; Infection follows. | Consume qualified hazard proof through actual planner/executor; preserve path/floor guards, coordinates, tolerances and accepted pursuit/rearm. Existing diagnostic-only test did not prove end-to-end repair. Do not relabel the old accepted branch as failed. |
