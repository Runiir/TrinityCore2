...
Updated 2026-09-24. Magmaw 10N finish line reached on label b5-d1898555 (scoreboard verdict pass, 8 kills, 0 deaths); rows marked closed below still need their verbatim move to the archive. This file holds only open items and an index of every ID.
...
| DPS-064 | open | Fire Mages | Closed 2026-09-24: baiter rotation per wave (bundle 05); Fire A 42491 (1.06) and Fire B 46596 (1.16) on b5-d1898555 |  |
| DPS-065 | open | Several DPS actors and references | Closed 2026-09-24: Balance 40371 (0.98) on b5-d1898555; actor_30001 accepted |  |
| DPS-066 | open | Elemental Shaman | Closed 2026-09-24: Elemental 41004 (0.98) on b5-d1898555 (8 kills); the b2 drop was proc RNG |  |
...
| HEAL-002 | open | Healers | Bundle 04 kept; priest 5-6 s gaps at full tank health remain |  |
| HEAL-003 | open | Healers | Closed 2026-09-24: no strand in 14 kills on b4/b5 |  |
...
| TANK-002 | open | Blood Death Knight tank | Closed 2026-09-24: 0.96 on b5-d1898555; lawful headroom left: the seized Heart Strike rule keeps a Blood rune for Rune Tap even above its 60% health gate (0 seat Heart Strikes), Rune Weapon copies ~67% |  |
| TANK-003 | open | Blood Death Knight tank | Closed 2026-09-24: Mangle cooldown plan, rune hold and Bone Shield reservation (bundles 04+05); 0 boss-window deaths in 21 kills on b4/b5 |  |
