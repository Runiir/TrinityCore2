...
| --- | --- | --- | --- |
| DPS-045 | Survival replacement pending native validation; broader class gaps diagnosed | Magmaw30009 changes MM→Survival with promoted setup and preserved bait/Disengage duties;36 focused and eight additional policy tests pass, independent review approved. WCL Y8ajQ7dbmKMG1RZy fight22 remains qualified class reference; xAhkN2y9YP3KRmnJ fight10 has two Survival Hunters. Affliction wastes18 long-DoT submissions on parasites and lacks Doomguard; Force of Nature is misclassified as area damage; Blood/healers have zero permanent item enchants. | Validate only the requested Survival swap in one canonical watchdog run and review all actors. Preserve separate repair packets and unexplained Affliction crit/proc/event variance. Do not tune coefficients or treat WCL totals as a matched floor. See magmaw_dps_baseline_20260913.md. |
...
| DPS-047 | Invalid ranged Survival AoE trap requests inward movement | Source699 trap13813 has10 failed native attempts/0damage. Native self-placement range0 conflicts with enemy-target AoE row2149; +50.483 inward range path, +53.118 parasite191 contact, +55.490 Infection. | Disable only invalid remote AoE row through production admission; keep MultiShot and calibration opener. Test/review/one native canary. Do not infer this caused all six Infection hits or all caster losses; inspect actual safety/movement outcomes. |
