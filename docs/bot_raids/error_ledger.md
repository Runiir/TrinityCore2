...
| DPS-046 | Survival shot-range and core-ST density admission blocks offense | Source8146 clear137.163s,205544.666raidDPS; Survival14603.545DPS. Head38.4835yd stationary/LOStrue; seven masks reject Cobra/Serpent range, six reject Explosive/BlackArrow enemy count. Loaded profile274v17 max35; native shots40 and Kill45. | Correct only Survival shot caps and core ST ceilings with production gate fixtures, independent review and one watchdog recovery run. Separate trap13813 row2149 has41 body native-range failures and remains unresolved; no coefficient or geometry change. |
