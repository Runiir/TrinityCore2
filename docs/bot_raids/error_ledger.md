...
| --- | --- | --- | --- |
| DPS-049 | Affliction Doomguard implementation active | Source05f actor30008 has no18540 in either profile or42-spell admission. Native18540 is a reagent-free, zero-range self summon; copying Demonology's hostile range/count row would add another failure. | Add profile action and canonical spell provisioning together; test actual self submission, reservation and native gates. Validate owned Doomguard damage without replacing Felhunter. No coefficient or transient-add-policy changes in this repair. |
