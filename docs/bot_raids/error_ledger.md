...
| ENC-005 | Research-backed native discrepancy; target-era compatibility pending | Sweltering Armor is applied on Mangle boarding, while historical 10N and 25H WCL apply it at Mangle removal. | See [longer WCL evidence](magmaw_longer_wcl_20260912.md). Validate successful release versus reset/death before moving the application; no causal DPS attribution or combat fix claimed. |
