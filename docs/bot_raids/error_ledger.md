...
| --- | --- | --- | --- |
| DPS-043 | Fixed-baiter repair independently approved; native validation pending | On26, Multi-Shot is selected twice at+44.55/+44.65s on parasite189 but native LOS rejects both; zero Multi-Shot lands. | Fixed-baiter SelectDamageTarget bypasses filtered opportunities for raw NearestParasite. Existing fixture expects blocked215 despite legal216. Select legal damage targets or an explicit safe fallback while retaining bait/threat assignment and movement ownership. Exact-tick live alternate legality remains unobserved. No superior eligible Mage AoE bypass is proven. |
