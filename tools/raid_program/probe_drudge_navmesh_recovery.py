...
EXPECTED_OUTPUT = (
    ...
    "recovery_slot1 smooth=0x40000000 points=9 terminal=-288.8,-86.483,214.154",
    "recovery_slot1 future_boss_minimum=29.1912",
    "recovery_slot2 nearest_terminal=-338.018,-64.932,213.233 requested_endz=0.482346",
    "recovery_slot2 findPath=0x40000000 polys=2 complete=1",
    "recovery_slot2 smooth=0x40000000 points=7 terminal=-338.018,-64.932,212.751",
    "recovery_slot2 future_boss_minimum=26.2785",
    "recovery_slot3 findPath=0x40000000 polys=14 complete=1",
    "recovery_slot3 smooth=0x40000000 points=14 terminal=-297.339,-115.904,214.552",
    "recovery_slot3 future_boss_minimum=38.7336",
    "recovery_slot4 findPath=0x40000000 polys=13 complete=1",
    "recovery_slot4 smooth=0x40000000 points=13 terminal=-298.8,-116.5,214.438",
    ...
    "recovery_slot7 findPath=0x40000000 polys=17 complete=1",
    "recovery_slot7 smooth=0x40000000 points=16 terminal=-293.6,-118.133,215.488",
...
def run_probe(root: Path = ROOT) -> dict[str, object]:
    ...
    return {
        ...
        "validated_returns": {
            ...
            "recovery_formation": {
                "1": {"start": [-289.289093, -57.7575, 212.932236], "terminal": [-288.8, -86.483, 214.154], "polygons": 9, "smooth_points": 9, "future_boss_minimum": 29.1912},
                ...
                "4": {"start": [-298.8, -71.5, 213.461], "terminal": [-298.8, -116.5, 214.438], "polygons": 13, "smooth_points": 13, "future_boss_minimum": 39.9585},
                ...
                "7": {"start": [-292.5, -69.1, 214.024], "terminal": [-293.6, -118.133, 215.488], "polygons": 17, "smooth_points": 16, "future_boss_minimum": 38.6956},
