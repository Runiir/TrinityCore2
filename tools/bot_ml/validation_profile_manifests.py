...
DEFAULT_ACTION_PROFILE_MANIFEST = Path("experiments/configs/cata_434_action_profiles.json")
DEFAULT_COMBAT_LOOT_PROFILE_MANIFEST = Path("experiments/configs/cata_434_combat_loot_profiles.json")
