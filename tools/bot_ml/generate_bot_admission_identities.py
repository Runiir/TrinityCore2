...
try:
    from .permanent_enchant_overlays import (
        DEFAULT_OVERLAYS,
...
def source_descriptor(
    ...
    permanent_enchant_overlays_path: Path = DEFAULT_OVERLAYS,
) -> dict[str, Any]:
    return {
        ...
        "sources": {
            ...
            "cata_blood_permanent_enchant_overlays_v1.json": _file_sha256(
                permanent_enchant_overlays_path
            ),
        },
    }
...
def load_gear_profiles(
    ...
    return apply_permanent_enchant_overlays(profiles, permanent_enchant_overlays_path)
...
def render_header(catalog: Mapping[str, Any]) -> str:
    ...
    permanent_enchant_overlays_hash = descriptor["sources"][
        "cata_blood_permanent_enchant_overlays_v1.json"
    ]
    return "\n".join(
        [
            ...
            f"inline constexpr char PermanentEnchantOverlaysSourceSha256[] = \"{permanent_enchant_overlays_hash}\";",
            "",
...
def main() -> int:
    ...
    rendered = render_header(build_identity_catalog(
        args.targets,
        args.gear_profiles,
        args.wowsims_gear_profiles,
        args.permanent_enchant_overlays,
    ))
    if args.check:
