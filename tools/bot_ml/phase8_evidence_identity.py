...
def build_projection(payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if not isinstance(bound_build, Mapping):
        raise ValueError("Phase 8 evidence identity manifest is missing build identity")
    projection = {
    ...
    if (
        ...
        raise ValueError("Phase 8 evidence identity build projection is invalid")
    return projection
...
def validate_manifest(
    ...
    *,
    ...
    if (
        ...
        raise ValueError("Phase 8 evidence identity build binding is invalid")
